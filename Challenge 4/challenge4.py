#hint: One small letter, surrounded by <b>EXACTLY</b> three big bodyguards on 
#each of its sides.

#found answer here: https://docs.python.org/2/howto/regex.html
# and here: http://stackoverflow.com/questions/9795955/multiple-occurences-of-same-character-in-a-string-regexp-python

#thinking out loud:
# maybe challenge.isupper()challenge.isupper()challenge.isupper()challenge.islower()challenge.isupper()challenge.isupper()challenge.isupper()
# need a find function to use, and look for UUULUUU pattern

import re

challenge = '''kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
answer = search.findall(challenge)

print answer
#answer is linkedlist
#...actually its \linkedlist.php
